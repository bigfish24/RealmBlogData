...
+ (void)loadBlogData
{
    ...
    [[NSBundle bundleForClass:[BlogObject class]] pathForResource:@"blog" ofType:@"json"];
...
+ (NSString *)randomEmoji
{
    if (!emojiArray) {
        ...
        NSString *emojiFilePath = [[NSBundle bundleForClass:[BlogObject class]] pathForResource:@"emoji" ofType:@"json"];
